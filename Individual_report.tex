...
\lstset{
	...
	basicstyle=\fontsize{10pt}{12pt}\selectfont\ttfamily,  % Set font style and size to 10pt with a normal line spacing of 12pt
...
% Start a new page for the bibliography and add it to the ToC.
\clearpage % This ensures the page is moved forward before adding the ToC entry.
\addcontentsline{toc}{chapter}{References}  % Add References to ToC as a chapter.
\bibliographystyle{IEEEtran}
\bibliography{references} % This now correctly aligns with the ToC link.

% Appendices
\clearpage % Start a new page for the appendices.
\addcontentsline{toc}{chapter}{Appendices}  % Add Appendices to ToC as a chapter.
\begin{appendices}
	\input{appendix.tex}
\end{appendices}
