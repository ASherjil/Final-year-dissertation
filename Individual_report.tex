...
%Adjust TOC page------------------------------------
\usepackage{etoolbox} % Load the etoolbox package to use \patchcmd
\makeatletter
\patchcmd{\tableofcontents}{\contentsname}{\vspace*{1cm}\contentsname}{}{} 
\makeatother
%-----------------------------------------------------------

% Add a header and footers-------------------------
\definecolor{headergray}{gray}{0.5}
\usepackage{fancyhdr}
\usepackage{lastpage} % Needed to reference the last page

\pagestyle{fancy}
\fancyhf{} % clear all header and footer fields
\fancyhead[L]{\fontsize{12}{14}\selectfont\color{headergray}Wolfson School of Mechanical, Electrical and Manufacturing Engineering}
\fancyfoot[C]{Page \thepage\ of \pageref{LastPage}} % Page numbering
\renewcommand{\headrulewidth}{0pt} % no line in header area
\renewcommand{\footrulewidth}{0pt} % no line in footer area

% Ensure the plain page style, used on chapter opening pages, is also consistent
\fancypagestyle{plain}{
	\fancyhf{} % clear all header and footer fields for plain pages
	\fancyhead[L]{\fontsize{12}{14}\selectfont\color{headergray}Wolfson School of Mechanical, Electrical and Manufacturing Engineering}
	\fancyfoot[C]{Page \thepage\ of \pageref{LastPage}} % consistent page numbering
...
\begin{titlepage}
	...
	\fancyhead[L]{\fontsize{12}{14}\selectfont\color{headergray}Wolfson School of Mechanical, Electrical and Manufacturing Engineering}
	\fancyfoot[C]{Page \thepage\ of \pageref{LastPage}} % Page numbering
	\thispagestyle{fancy} % Apply the header/footer styling to the title page
	%------------------------------
